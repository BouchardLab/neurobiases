...
def cv_sparse_em_solver_full(
    ...
    for task_idx, (tuning_sparsity,
        ...
        # Score the resulting fit
        mlls[task_idx] = emfit.marginal_log_likelihood(X=X_test, Y=Y_test, y=y_test)
        # Calculate BIC
...
def cv_sparse_tc_solver_full(
    ...
    """Performs a cross-validated, sparse TCM fit on data generated from a TM.
